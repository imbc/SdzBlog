...
class CommentFixtures extends AbstractFixture implements OrderedFixtureInterface
{
    ...
    public function load( ObjectManager $manager )
    {
        ...
        $comment1->setPost( $manager->merge( $this->getReference( 'post-1' ) ));
        ...
        $comment2->setPost( $manager->merge( $this->getReference( 'post-1' ) ));
        ...
        $comment3->setPost( $manager->merge( $this->getReference( 'post-2' ) ));
        $manager->persist( $comment3 );

        $comment4 = new Comment();
        $comment4->setAuthor( 'Kate' );
        $comment4->setContent( 'Are you challenging me? ' );
        $comment4->setPost( $manager->merge( $this->getReference( 'post-2' ) ));
        ...
        $comment5->setPost( $manager->merge( $this->getReference( 'post-2' ) ));
        ...
        $comment6->setPost( $manager->merge( $this->getReference( 'post-2' ) ));
        ...
        $comment7->setPost( $manager->merge( $this->getReference( 'post-2' ) ));
        ...
        $comment8->setPost( $manager->merge( $this->getReference( 'post-2' ) ));
        ...
        $comment9->setPost( $manager->merge( $this->getReference( 'post-2' ) ));
        ...
        $comment10->setPost( $manager->merge( $this->getReference( 'post-2' ) ));
        ...
        $comment11->setPost( $manager->merge( $this->getReference( 'post-2' ) ));
        ...
        $comment12->setPost( $manager->merge( $this->getReference( 'post-2' ) ));
        ...
        $comment13->setPost( $manager->merge( $this->getReference( 'post-3' ) ));
        ...
        $comment14->setPost( $manager->merge( $this->getReference( 'post-3' ) ));
        ...
        $comment15->setPost( $manager->merge( $this->getReference( 'post-5' ) ));
        $manager->persist( $comment15 );

        $comment16 = new Comment();
        $comment16->setAuthor( 'Gary' );
        $comment16->setContent( 'Bill Who?' );
        $comment16->setPost( $manager->merge( $this->getReference( 'post-5' ) ));
